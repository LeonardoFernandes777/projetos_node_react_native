...
export default function HomeAlmox() {
  ...
  return (
    <div>
      ...
      <div className="div-container" style={{ paddingLeft: 250, width: '95%' }}>
        <h1 style={{ color: '#E02041', fontSize: 35 }}>TELA INICIAL ALMOXARIFADO</h1>
        <form className="cadastro-funcionario">
          ...
          <select style={{ border: '1px solid #dcdce6', color: '#333', borderRadius: '8px', width: '100%', height: '60px', marginTop: 10, padding: '0 24px', fontSize: 17 }} name="categorias">
            ...
            <option value="Hamburger">Carnes</option>
            <option value="Pizza">Frios</option>
            <option value="Macarrão">Temperos</option>
            <option value="Bebidas">Verduras</option>
            <option value="Doces">Massas</option>
            <option value="Doces">Molhos</option>
            <option value="Doces">Gás</option>
            <option value="Doces">Produtos Congelados</option>
          ...
          <div className="input-group">
            <input style={{width: 1250 }} placeholder="Preço" />
            <select style={{ border: '1px solid #dcdce6', color: '#333', borderRadius: '8px', width: '100%', height: '60px', marginTop: 10, padding: '0 24px', fontSize: 17, marginLeft: 5 }} name="categorias">
            <option value="null">Unidade de Medida</option>
